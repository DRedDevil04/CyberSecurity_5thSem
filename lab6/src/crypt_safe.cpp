...
void CryptSafe::GenerateSharedSecretKeyA(const std::string& publicKeyStr, const std::string& privateKeyFile, const std::string& outputFile) {
    ...
    Integer pubKey;
    FileSource pubKeySource("publicKeyB.bin", true /* binary mode */);
...
void CryptSafe::GenerateSharedSecretKeyB(const std::string& publicKeyStr, const std::string& privateKeyFile, const std::string& outputFile) {
    ...
    // Compute the shared secret key
    Integer pubKey;
    FileSource pubKeySource("publicKeyA.bin", true /* binary mode */);
    pubKey.BERDecode(pubKeySource);
