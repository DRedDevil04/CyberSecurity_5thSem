...
namespace cryptsafe {
    ...
    void CryptSafe::Verification(const std::string& hashed_file, const std::string& messageFile, const std::string& publickeyfile){

        this->MD5Hash("msgHash2.bin",messageFile);
        this->DecryptionPhase(publickeyfile,hashed_file,"verification_hash.bin");
